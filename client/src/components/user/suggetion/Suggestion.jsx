...
const Suggestion = ({ user }) => {
  ...
  return (
    <div className="flex item-center content-center p-1 justify-between mt-2 ">
      <div
      ...
      <div className="flex item-center content-center gap-x-1">
        <button
          class="bg-cyan-800 hover:bg-cyan-900 text-sm self-center text-white font-bold  h-6 w-16 border border-cyan-900 rounded"
          onClick={() => {
            toProfile(user?._id);
          }}
        >
