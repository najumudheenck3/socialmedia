    ...
    <div>
      <div className="flex items-center justify-between gap-5 my-5">
        <img
          ...
          alt=""
        />
        <input className="w-full p-2  bg-transparent" type="text" placeholder="write a comment" />
        <button className="bg-specclr h-8 w-16 rounded-md text-white cursor-pointer">send</button>
      </div>
      {comments.map((comment) => (
        <div className="my-4 flex justify-between gap-5">
          ...
          <span className="self-center text-gray-500 text-xs">1 hour ago</span>
        </div>
      ))}
    </div>
  );
