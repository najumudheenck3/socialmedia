    ...
    <div>
      <div className="images w-full h-60 ">
        <img className="w-full h-full object-cover relative"
          ...
          alt=""
        />
        <img className="absolute right-0  left-0 m-auto top-52 w-44 h-44 rounded-full object-cover" src="https://wallpaperaccess.com/full/2213424.jpg" alt="" />
      </div>
        ...
        <div className="userIfo h-52 shadow-md  rounded-lg p-8 flex items-center justify-between mb-5 bg-white">
         ...
         <EmailRoundedIcon fontSize="large" />
          ...
          <div className="centerere flex-1 flex mt-6 flex-col items-center gap-2">
            <span className="text-3xl font-medium">John doe</span>
            <div className="infooo flex items-center justify-around w-full">
              ...
              <button className="bg-cyan-800 hover:bg-cyan-900 text-sm text-white font-bold  h-6 w-16 border border-cyan-900 rounded">follow</button>
          </div>
